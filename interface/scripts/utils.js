export default {
  ...
  escapeSequences: {
    ...
    "\r": "\\r", // carriage return (U+000D CARRIAGE RETURN; CR)
  ...
  /**
   * Escapes JavaScript escape sequences
   * @param {*} str
   * @returns
   */
  escapeEscapeSequences: function escapeEscapeSequences(str) {
    let newStr = str;
    for (const [seq, escaped] of Object.entries(this.escapeSequences)) {
      newStr = newStr.replaceAll(seq, escaped);
    }
    return newStr;
  },
